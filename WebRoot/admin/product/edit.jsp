			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						...
						<select name="is_hot">
							<option value="1"  selected="<s:if test='model.is_hot==1'>selected</s:if>">是</option>
							<option value="0"  selected="<s:if test='model.is_hot==0'>selected</s:if>">否</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="categorySecond.csid">
							<s:iterator var="cs" value="csList">
								<option value="<s:property value="#cs.csid"/>" selected="<s:if test='#cs.csid == model.categorySecond.csid'>selected</s:if>"><s:property value="#cs.csname"/></option>
							</s:iterator>
						</select>
					</td>
				</tr>
